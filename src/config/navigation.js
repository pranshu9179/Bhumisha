  ...
  [ROLES.ADMIN]: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "Crop Details",
          description: "Crop-wise bilingual detail sections and carousel media.",
          path: "/admin/crop-details",
          icon: Images,
        },
        {
    ...
    },
    {
      ...
      items: [
        {
          title: "Audit Logs",
          description: "Activity trace and governance.",
          path: "/admin/audit-logs",
          icon: ReceiptText,
        },
        {
          title: "Settings",
          description: "Platform preferences and workflow controls.",
          path: "/admin/settings",
          icon: Settings,
        },
      ],
  ...
  [ROLES.EXPERT]: [
    {
      ...
      items: [
        ...
        {
          title: "Notifications",
          description: "Recent updates and reassignment alerts.",
  ...
  [ROLES.EMPLOYEE]: [
    {
      ...
      items: [
        ...
        {
          title: "Task Board",
          description: "Kanban view of operational follow-ups.",
          path: "/employee/tasks",
          icon: KanbanSquare,
        },
        {
        ...
        },
        {
          ...
          description: "Resolve onboarding and order help cases.",
          path: "/employee/vendor-support",
          icon: LifeBuoy,
        },
        {
          title: "Reports",
          description: "Team throughput and issue themes.",
  ...
  [ROLES.VENDOR]: [
    {
      ...
      items: [
        ...
        {
          title: "Reports",
          description: "Revenue, SKUs, and conversion insights.",
          path: "/vendor/reports",
